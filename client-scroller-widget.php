...
// Images section
		...
		echo
		'<p>' . __('You can drag and align image order', $this->textdomain) . '</p>
		...
		<br/>
<a href="http://www.youdreamwedevelop.com/wordpress-plugin-development/"target="_blank">Click </a>&nbsp; to find more about this plugin.
